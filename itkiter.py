...
def cli(path, image_suffix, segmentation_suffix, additional_image_suffix, extension, dry):
    '''Iterate over multiple folders of images and segmentations at the specified path with ITK-SNAP. File names are generated by concatenating each folder name within the path with the specified suffixes and extension.'''
    ...
    # Ensure the leading '.' on the extension is optional
    if extension[0] != '.': extension = f'.{extension}'
